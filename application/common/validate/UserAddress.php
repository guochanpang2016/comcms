...
class UserAddress extends Validate
{
    ...
    protected $rule = [
        ...
        ['name', 'require|max:60', '收货人姓名不能为空|收货人姓名格式不正确'],
        ['country_id', 'require|number|max:11', '收货人的国家ID不能为空|收货人的国家ID必须是数字|收货人的国家ID格式不正确'],
        ['province_id', 'require|number|max:11', '收货人的省份ID不能为空|收货人的省份ID必须是数字|收货人的省份ID格式不正确'],
        ['city_id', 'require|number|max:11', '收货人城市ID不能为空|收货人城市ID必须是数字|收货人城市ID格式不正确'],
        ['district_id', 'require|number|max:11', '收货人的地区ID不能为空|收货人的地区ID必须是数字|收货人的地区ID格式不正确'],
        ['address', 'require|max:60', '收货人的详细地址不能为空|收货人的详细地址格式不正确'],
        ['mobile', 'require|isMobile', '收货人的手机号不能为空|收货人的手机号格式不正确'],
