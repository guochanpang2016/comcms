...
class Bonus extends Validate
{
    ...
    protected $rule = [
        ...
        ['money', 'require|regex:/^\d{0,10}(\.\d{0,2})?$/|>:0', '优惠券金额不能为空|优惠券金额格式不正确|优惠券金额必须大于0'],
        ['min_amount', 'require|regex:/^\d{0,10}(\.\d{0,2})?$/', '满多少使用不能为空|满多少使用格式不正确'],
        ['start_time', 'require|number|max:11', '开始时间不能为空|开始时间格式不正确|开始时间格式不正确'],
        ...
        ['point', 'number|max:11', '兑换优惠券所需积分不能为空|兑换优惠券所需积分必须是数字'],
