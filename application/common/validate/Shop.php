...
class Shop extends Validate
{
    ...
    protected $rule = [
        ...
        ['email', 'require|max:20|email', '邮箱不能为空|邮箱不能超过20个字符|邮箱格式不正确'],
        ['user_name', 'require|max:60', '用户名不能为空|用户名不能超过60个字符'],
        ['password', 'require|max:20|checkPWD', '密码不能为空|密码不能超过20个字符'],
        ...
        ['mobile', 'require|max:20|checkPhone', '手机号不能为空|手机号不能超过60个字符'],
        ...
        ['category_id', 'require|number|>:0', '类目不能为空|类目格式不正确|类目不能为空'],
