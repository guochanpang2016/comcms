...
class Order extends Validate
{
    ...
    protected $rule = [
        ...
        ['order_sn', 'require|max:30', '订单号不能为空|订单号不能超过30个字符'],
        ...
        ['goods_amount', 'require|regex:/^\d{0,10}(\.\d{0,2})?$/', '商品的总金额不能为空|商品的总金额格式不正确'],
        ['order_amount', 'require|regex:/^\d{0,10}(\.\d{0,2})?$/', '应付金额不能为空|应付金额格式不正确'],
        ['discount', 'require|regex:/^\d{0,10}(\.\d{0,2})?$/', '优惠金额不能为空|优惠金额格式不正确'],
        ['pay_money', 'regex:/^\d{0,10}(\.\d{0,2})?$/', '支付金额不能为空|支付金额格式不正确'],
        ...
        ['country_id', 'require|number|max:11', '国家ID不能为空|国家ID格式不正确|国家ID格式不正确'],
        ['province_id', 'require|number|max:11', '省份ID不能为空|省份ID格式不正确|省份ID格式不正确'],
        ['city_id', 'require|number|max:11', '城市ID不能为空|城市ID格式不正确|城市ID格式不正确'],
        ['district_id', 'require|number|max:11', '区域ID不能为空|区域ID格式不正确|区域ID格式不正确'],
        ...
        ['delete_time', 'require|number|max:11', '删除时间不能为空|删除时间格式不正确|删除时间格式不正确'],
    ];
